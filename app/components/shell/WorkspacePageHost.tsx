  ...
  return (
    <PageModuleBoundary definition={definition} toolbarProvided={definition.hostToolbarProvided}>
      {message && createPortal(
        <div className="pointer-events-none fixed inset-x-0 top-4 z-[400] flex justify-center px-4 sm:left-auto sm:right-4 sm:top-20 sm:w-[min(32rem,calc(100vw-2rem))] sm:px-0">
