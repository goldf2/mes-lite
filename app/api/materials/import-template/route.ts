...
const rows = [
  ['物料编码', '物料名称', '规格', '备注', '分类', '客户编码', '库存单位', '启用双单位', '核算单位', '换算系数', '成本方法', '换算说明'],
  ['CUST-AL-001', '左侧铝型材支架', '6063-T5 / 20x40 / L=120mm', '客户零件号可作为物料编码', 'FINISHED', 'CUST001', '件', '否', '', '', 'WEIGHTED_AVERAGE', ''],
  ['AL-RAW-001', '铝型材原料', '6063-T5 / 20x40 / 6m', '按根领料，按重量计价', 'RAW', '', '根', '是', 'kg', '2.35', 'FIFO', '按理论重量，可在来料单按实重修正'],
]
