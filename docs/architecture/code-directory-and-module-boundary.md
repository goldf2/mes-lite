...
| `app/components/` 根目录 | 59 个文件 | 物料、全景、BOM 全览、来料和派工页已迁出；公共弹窗只保留一个全屏切换组件，其他领域页面、业务弹窗和系统页面仍继续按增量原则收敛 |
...
| `modules/` | 141 个文件 | 已有工作台、生产、库存、配置、物料、BOM、系统设置、运维工具、文档、来料和身份权限 11 个模块；生产工程与派工、物料、BOM、文档、来料、库存与身份权限已形成垂直分层 |
