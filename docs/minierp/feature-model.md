...
| BOM成本 | 选择产品并展开 BOM，按库存材料成本、成本对象工时机时和固定费用分摊生成成本快照；提供成本数据页签检查成本对象、BOM 组成、工艺参数和最近成本 | 是 |
| 可计算加工工艺 | 工艺模板保存批量、节拍、人员、设备、费率和合格率，输出千件工时、机时和成本 | 是 |
| 产品工艺成本路线 | 从可计算工艺模板组合产品工序，保存参数快照并汇总千件工时、机时和成本 | 是 |
