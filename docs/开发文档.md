...
>
> 事实基线：`v0.1.346` / 2026-08-12。代码会持续变化；当文档与代码冲突时，以 `lib/page-registry.ts`、`lib/permissions.ts`、`prisma/schema.prisma` 和实际 API 为准。
>
...
当前有 120 个 `app/api/**/route.ts` 文件，覆盖：
...
当前还没有自动生成的 OpenAPI 规范。对外集成的新 API 应建立契约文档，而不把 120 个路由手工复制到本手册。
