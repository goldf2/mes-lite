...
>
> 事实基线：`v0.1.339` / 2026-08-10。代码会持续变化；当文档与代码冲突时，以 `lib/page-registry.ts`、`lib/permissions.ts`、`prisma/schema.prisma` 和实际 API 为准。
>
...
当前 `prisma/schema.prisma` 包含 **64 个数据模型**，建议按数据不变式而不是表名孤立理解：
