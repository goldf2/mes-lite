...
| 你想了解的问题 | 首选文档 |
| --- | --- |
| 第一次完整理解系统，并据此复盘功能是否完备 | [系统全景索引](./architecture/系统全景索引.md) |
...
| 前端、API、权限、数据库、文件和部署环境如何连接 | [系统结构图](./architecture/系统结构图.md) |
| 来料、生产、质量、库存、销售退货和设备维保如何闭环 | [MES 当前功能流程与泳道](./architecture/MES当前功能流程与泳道.md)、[系统时序图](./architecture/系统时序图.md) |
| 17 个模块分别做什么，哪些已闭环、哪些仍有缺口 | [系统功能全景与完备性审查](./architecture/系统功能全景与完备性审查.md) |
...
| 如何按界面完成当前已交付的业务流程 | 站内“帮助中心”或顶部问号；快捷帮助和完整帮助都可新开全屏页面并播放关联视频。当前同源文件见 [Markdown](./operations/user-guide/MES-lite全流程作业指导书-v0.1.401.md)；首批跨页面视频分镜见[常用工作流视频 SOP](./operations/user-guide/workflow-videos/README.md)。DOCX、PDF、离线 Web 和视频按 [SOP 生成与发布策略](./operations/SOP生成与发布策略.md)及[视频帮助分类与发布](./operations/视频帮助分类与发布.md)管理，不进入 Git/Docker 发布树 |
...
| 当前开发是否可以冻结，距离生产验收还缺哪些唯一门禁 | [开发冻结与生产验收交接清单](./delivery/开发冻结与生产验收交接清单.md) |
| 开发结束后还有哪些事项、由谁人工跟进 | [开发结束与人工跟进事项清单](./delivery/开发结束与人工跟进事项清单.md) |
...
- [系统功能全景与完备性审查](./architecture/系统功能全景与完备性审查.md)
...
- MES-lite 全流程作业指导书（与站内帮助同源）：[Markdown](./operations/user-guide/MES-lite全流程作业指导书-v0.1.401.md)；[常用工作流视频 SOP](./operations/user-guide/workflow-videos/README.md)；[SOP 生成与发布策略](./operations/SOP生成与发布策略.md)；[视频帮助分类与发布](./operations/视频帮助分类与发布.md)
...
- [开发冻结与生产验收交接清单](./delivery/开发冻结与生产验收交接清单.md)
