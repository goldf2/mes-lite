...
export function validateStockBalance(stock: StockBalanceSnapshot) {
  ...
  if (stock.qty < -STOCK_BALANCE_TOLERANCE || stock.reservedQty < -STOCK_BALANCE_TOLERANCE || stock.availableQty < -STOCK_BALANCE_TOLERANCE || stock.quarantineQty < -STOCK_BALANCE_TOLERANCE || stock.holdQty < -STOCK_BALANCE_TOLERANCE || stock.reworkQty < -STOCK_BALANCE_TOLERANCE) reasons.push('库存数量不能为负数')
