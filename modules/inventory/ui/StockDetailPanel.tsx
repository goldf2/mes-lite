              ...
              <div key={balance.id} className="py-3">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    <div className="mt-1 text-[11px] text-gray-500">预留 {stockQuantityText(balance.reservedQty)} · 可用 {stockQuantityText(balance.availableQty)} · 待检 {stockQuantityText(balance.quarantineQty)} · 冻结 {stockQuantityText(balance.holdQty)} · 返工中 {stockQuantityText(balance.reworkQty)}</div>
                  </div>
