...
export default function ProcessRoutePage({ onMessage, actions, canCreate, canUpdate }: { onMessage: (message: string) => void; actions?: ReactNode; canCreate: boolean; canUpdate: boolean }) {
