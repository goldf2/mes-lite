...
export const workCenterFieldsSchema = z.object({
  ...
  laborRatePerHour: z.number().finite().nonnegative().default(0),
  machineRatePerHour: z.number().finite().nonnegative().default(0),
  energyCostPerHour: z.number().finite().nonnegative().default(0),
...
export type WorkCenterInput = z.input<typeof workCenterFieldsSchema>
export type WorkCenterUpdateInput = z.input<typeof workCenterUpdateSchema>
