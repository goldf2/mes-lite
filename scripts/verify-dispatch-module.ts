...
function verifyStaticBoundaries() {
  ...
  assert.match(page, /BusinessDocumentPrintLink/, '派工清单必须保留独立打印入口')
  assert.doesNotMatch(page, /generateBusinessDocumentPdfArchives|reserveBusinessDocumentPrintWindow/, '派工创建与 PDF 打印必须分离')
