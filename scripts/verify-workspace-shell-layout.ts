...
assert.match(shellSource, /autoHideDesktopNavigation\s*&&\s*!transientNavigationOpen[\s\S]*?aria-hidden="true"[\s\S]*?onPointerEnter=\{scheduleDesktopNavigationOpen\}[\s\S]*?w-\[30px\]/, '自动隐藏左栏必须提供屏幕左侧 30px 悬停感应带')
