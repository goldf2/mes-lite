...
assert.match(homeApp, /<UnifiedNavigationMenu[\s\S]*?groups=\{navigationGroups\}/, '移动抽屉必须使用公共菜单骨架')
...
console.log('响应式菜单校验通过：桌面顶部、桌面侧栏和移动抽屉共用同一菜单骨架；常用入口与同级菜单作为统一模型上的快捷入口。')
