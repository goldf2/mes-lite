...
assert.equal(workspaceContainsFunction(defaults, 'mrp', 'helpCenter'), true, '帮助中心必须在 MRP 工作区可见')
assert.equal(workspaceContainsFunction(defaults, 'erp', 'helpCenter'), true, '帮助中心必须在 ERP 工作区可见')
