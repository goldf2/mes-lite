...
export const permissionResources = [
  ...
  { key: 'workInstructions', label: '作业指导书' },
  { key: 'materialIn', label: '来料管理' },
  { key: 'dispatch', label: '派工管理' },
  { key: 'stocks', label: '库存管理' },
  { key: 'profileStock', label: '型材实体库存' },
  { key: 'cuttingPlans', label: '切割排样' },
  { key: 'cuttingTasks', label: '锯切执行' },
  { key: 'productionLots', label: '后续加工与质检' },
...
const operatorDefaults: PermissionMap = {
  ...
  dispatch: readCreate,
  stocks: readOnly,
  profileStock: readOnly,
  cuttingPlans: readCreate,
  cuttingTasks: readCreateUpdate,
  productionLots: readCreateUpdate,
  shipment: readCreate,
  return: readCreate,
...
const auditorDefaults: PermissionMap = {
  ...
  profileStock: { canRead: true, canCreate: false, canUpdate: true, canDelete: false, canGrant: false },
  cuttingPlans: readCreateUpdate,
  cuttingTasks: readCreateUpdate,
  productionLots: readCreateUpdate,
