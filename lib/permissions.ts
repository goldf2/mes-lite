...
export const permissionResources = [
  ...
  { key: 'shipmentDispatch', label: '发货执行' },
  { key: 'shipmentDeliver', label: '客户签收确认' },
  { key: 'shipmentCancel', label: '发货取消' },
  { key: 'shipmentReverse', label: '发货冲销' },
  { key: 'return', label: '退货管理' },
  { key: 'returnReceive', label: '退货收货' },
  { key: 'returnReject', label: '退货拒绝' },
  { key: 'stats', label: '统计分析' },
  { key: 'flowTransfers', label: '流程转移' },
  { key: 'flowTransferConfirm', label: '流程转移确认' },
  { key: 'flowTransferReverse', label: '流程转移冲销' },
  ...
  { key: 'cadPreviewSettings', label: 'CAD 预览引擎' },
...
export const permissionResourceSections = [
  ...
  { key: 'production', label: '生产、质量与统计', resources: ['orders', 'productionOrderRelease', 'productionActualEntry', 'productionActualConfirm', 'productionActualReverse', 'dispatch', 'flowTransfers', 'flowTransferConfirm', 'flowTransferReverse', 'stats', 'quality', 'qualityStandards', 'qualityDecision', 'qualityDisposition', 'qualityRelease'] },
  ...
  { key: 'fulfillment', label: '来料、库存与销售', resources: ['materialIn', 'materialInReceive', 'materialInReverse', 'stocks', 'salesOrder', 'shipment', 'shipmentDispatch', 'shipmentDeliver', 'shipmentCancel', 'shipmentReverse', 'return', 'returnReceive', 'returnReject', 'suppliers', 'customers', 'locations'] },
  { key: 'administration', label: '人员、配置与运维', resources: ['employees', 'operators', 'businessSettings', 'displaySettings', 'navigationSettings', 'cadPreviewSettings', 'aiSettings', 'archive', 'auditLogs', 'dataTools', 'permissionUsers', 'permissionGroups'] },
...
const operatorDefaults: PermissionMap = {
  ...
  shipment: readCreate,
  shipmentDispatch: none,
  shipmentDeliver: none,
  shipmentCancel: none,
  shipmentReverse: none,
  return: readCreate,
  returnReceive: none,
  returnReject: none,
  stats: readCreateUpdate,
  flowTransfers: readCreateUpdate,
  flowTransferConfirm: none,
  flowTransferReverse: none,
  quality: none,
...
export const defaultPermissionGroups = [
  ...
  { code: 'production_executor', name: '生产执行组', description: '操作工查看任务、登记实绩草稿、扫码并确认正向流程转移；不发布、不确认生产过账、不冲销。', settings: permissionPreset({ orders: 'R', productionActualEntry: 'U', dispatch: 'R', flowTransfers: 'RCU', flowTransferConfirm: 'U', stocks: 'R', equipment: 'R', scanPrint: 'RCU' }) },
  { code: 'production_lead', name: '生产管理组', description: '班组长和生产主管发布订单、确认实绩，并执行受控生产或流程转移冲销。', settings: permissionPreset({ orders: 'RCUA', productionOrderRelease: 'U', productionActualEntry: 'UA', productionActualConfirm: 'U', productionActualReverse: 'U', dispatch: 'RCUA', flowTransfers: 'RCU', flowTransferConfirm: 'U', flowTransferReverse: 'U', stats: 'R', stocks: 'R', employees: 'R', locations: 'R', workCenters: 'R', scanPrint: 'RCU' }) },
  { code: 'warehouse_executor', name: '仓库作业组', description: '仓管员登记来料并执行收货、库存发出、退货入库和正向移库；不取消、拒绝或冲销。', settings: permissionPreset({ materials: 'R', materialIn: 'RCU', materialInReceive: 'U', stocks: 'RU', shipment: 'R', shipmentDispatch: 'U', return: 'R', returnReceive: 'U', flowTransfers: 'RCU', flowTransferConfirm: 'U', locations: 'R', scanPrint: 'RCU' }) },
  { code: 'warehouse_lead', name: '仓库管理组', description: '仓库主管在仓库作业基础上执行有原因的来料红冲、待发货取消、已发货冲销、退货拒绝和移库冲销。', settings: permissionPreset({ materials: 'R', materialIn: 'RCUA', materialInReceive: 'U', materialInReverse: 'U', stocks: 'RU', shipment: 'R', shipmentDispatch: 'U', shipmentCancel: 'U', shipmentReverse: 'U', return: 'R', returnReceive: 'U', returnReject: 'U', flowTransfers: 'RCU', flowTransferConfirm: 'U', flowTransferReverse: 'U', suppliers: 'R', locations: 'RCUA', scanPrint: 'RCU' }) },
  ...
  { code: 'sales_fulfillment', name: '销售发运组', description: '销售与跟单人员维护客户、订单、发货和退货，并确认客户签收或拒绝不符合条件的退货；不执行仓库出入库。', settings: permissionPreset({ materials: 'R', stocks: 'R', salesOrder: 'RCUA', shipment: 'RCUA', shipmentDeliver: 'U', shipmentCancel: 'U', return: 'RCUA', returnReject: 'U', suppliers: 'RCU', customers: 'RCU' }) },
