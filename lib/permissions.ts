...
export const permissionResourceSections = [
  ...
  { key: 'fulfillment', label: '来料、库存与销售', resources: ['materialIn', 'materialInReceive', 'materialInReverse', 'stocks', 'salesOrder', 'shipment', 'shipmentDispatch', 'shipmentDeliver', 'shipmentCancel', 'return', 'returnReceive', 'returnReject', 'suppliers', 'customers', 'locations'] },
...
export const defaultPermissionGroups = [
  ...
  { code: 'warehouse_lead', name: '仓库管理组', description: '仓库主管在仓库作业基础上执行有原因的来料红冲、发货取消、退货拒绝和移库冲销。', settings: permissionPreset({ materials: 'R', materialIn: 'RCUA', materialInReceive: 'U', materialInReverse: 'U', stocks: 'RU', shipment: 'R', shipmentDispatch: 'U', shipmentCancel: 'U', return: 'R', returnReceive: 'U', returnReject: 'U', flowTransfers: 'RCU', flowTransferConfirm: 'U', flowTransferReverse: 'U', suppliers: 'R', locations: 'RCUA', scanPrint: 'RCU' }) },
