...
const registeredPages = [
  ...
  registerPage({ key: 'helpCenter', tab: 'helpCenter', kind: 'workspace', title: '帮助中心', description: '按权限查找当前版本的流程作业指导书', renderer: 'sop-help-center', groupKey: 'workspace', resource: 'dashboard', primaryNavigation: true, workspace: { functionKey: 'helpCenter', label: '帮助中心', icon: '助' } }),
  ...
  registerPage({ key: 'bomWorkspace', tab: 'materials', materialSection: 'bomWorkspace', kind: 'master-detail', title: 'BOM 设置', description: '创建 BOM 或修改已有 BOM 的整批输入与输出', renderer: 'bom-workspace', groupKey: 'materials', resource: 'bom', presentation: { content: 'page' }, workspace: { functionKey: 'bomWorkspace', label: 'BOM 设置', icon: '本' } }),
  ...
  registerPage({ key: 'dailyInventory', tab: 'dailyInventory', kind: 'transaction', title: '生产日报', description: '按库位快速核对账面数与实盘数并过账差异', renderer: 'daily-inventory', groupKey: 'production', resource: 'stocks', primaryNavigation: true, hostToolbarProvided: true, presentation: { content: 'page' }, workspace: { functionKey: 'dailyInventory', label: '生产日报', icon: '报' } }),
  ...
  registerPage({ key: 'customers', tab: 'customers', kind: 'resource', title: '客户资料', description: '维护客户基础资料', renderer: 'system-section', groupKey: 'configuration', resource: 'customers', primaryNavigation: true, systemSection: 'customers', workspace: { functionKey: 'customers', label: '客户资料', icon: '客' } }),
  registerPage({ key: 'employees', tab: 'employees', kind: 'resource', title: '员工资料', description: '维护业务员工并供生产和转移单据选用', renderer: 'employees', groupKey: 'configuration', resource: 'employees', primaryNavigation: true, workspace: { functionKey: 'employees', label: '员工资料', icon: '员' } }),
  registerPage({ key: 'locationSettings', tab: 'locationSettings', kind: 'settings', title: '库位配置', description: '配置库位、用途和默认库位', renderer: 'system-section', groupKey: 'configuration', resource: 'locations', primaryNavigation: true, systemSection: 'locations', workspace: { functionKey: 'locationSettings', label: '库位配置', icon: '位' } }),
  registerPage({ key: 'unitSettings', tab: 'unitSettings', kind: 'settings', title: '单位配置', description: '配置计量单位和同量纲换算', renderer: 'system-section', groupKey: 'configuration', resource: 'units', primaryNavigation: true, systemSection: 'units', workspace: { functionKey: 'unitSettings', label: '单位配置', icon: '单' } }),
  registerPage({ key: 'documentCategories', tab: 'documentCategories', kind: 'settings', title: '文档类别', description: '维护产品文档使用的一级、二级业务分类', renderer: 'document-categories', groupKey: 'configuration', resource: 'documentCategories', primaryNavigation: true, workspace: { functionKey: 'documentCategories', label: '文档类别', icon: '类' } }),
  registerPage({ key: 'workCenters', tab: 'workCenters', kind: 'settings', title: '工作中心', description: '配置锯切、钻孔、检验等生产能力区域', renderer: 'system-section', groupKey: 'configuration', resource: 'workCenters', primaryNavigation: true, systemSection: 'workCenters', workspace: { functionKey: 'workCenters', label: '工作中心', icon: '中' } }),
  registerPage({ key: 'processTemplates', tab: 'processTemplates', kind: 'settings', title: '加工工艺', description: '维护加工工艺模板和成本参数', renderer: 'system-section', groupKey: 'configuration', resource: 'processTemplates', primaryNavigation: true, systemSection: 'processTemplates', workspace: { functionKey: 'processTemplates', label: '加工工艺', icon: '艺' } }),
  registerPage({ key: 'processRoutes', tab: 'processRoutes', kind: 'settings', title: '物料路线', description: '维护产品加工路线和工步', renderer: 'system-section', groupKey: 'configuration', resource: 'processRoutes', primaryNavigation: true, systemSection: 'process', workspace: { functionKey: 'processRoutes', label: '物料路线', icon: '线' } }),
  ...
  registerPage({ key: 'archive', tab: 'archive', kind: 'settings', title: '归档记录', description: '恢复或永久删除已归档记录', renderer: 'system-section', groupKey: 'tools', resource: 'archive', primaryNavigation: true, systemSection: 'recycle', workspace: { functionKey: 'archive', label: '归档记录', icon: '档' } }),
  registerPage({ key: 'auditLogs', tab: 'auditLogs', kind: 'settings', title: '操作记录', description: '查看业务和系统操作审计记录', renderer: 'system-section', groupKey: 'tools', resource: 'auditLogs', primaryNavigation: true, systemSection: 'audit', workspace: { functionKey: 'auditLogs', label: '操作记录', icon: '记' } }),
  registerPage({ key: 'dataTools', tab: 'dataTools', kind: 'utility', title: '数据工具', description: '执行数据检查和可控的错误数据清理', renderer: 'system-section', groupKey: 'tools', resource: 'dataTools', primaryNavigation: true, systemSection: 'dataTools', hostToolbarProvided: true, shellToolbarActions: true, presentation: { content: 'page' }, workspace: { functionKey: 'dataTools', label: '数据工具', icon: '数' } }),
