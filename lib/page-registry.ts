...
const registeredPages = [
  ...
  registerPage({ key: 'navigationSettings', tab: 'navigationSettings', kind: 'settings', title: '导航与工作区', description: '配置 MES、MRP、ERP 菜单唯一归属、名称和顺序', renderer: 'system-section', groupKey: 'system', resource: 'navigationSettings', primaryNavigation: true, systemSection: 'navigationSettings', workspace: { functionKey: 'navigationSettings', label: '导航与工作区', icon: '导' } }),
