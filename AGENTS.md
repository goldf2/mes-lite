...
- 常规小修复不强制每版新增独立发布说明，但必须在 `docs/releases/PENDING.md` 记录版本、变更、验证和待整理文档，供后续集中整理。
- 小修复期间不为了对齐版本号而机械修改全部架构/说明文档的事实基线；文档基线可落后于代码、不得领先于代码，待整理差异以 `docs/releases/PENDING.md` 为准。
- 里程碑、数据迁移、权限/安全、部署或重要业务流程变更仍必须新增 `docs/releases/v<版本号>.md`，并同步更新 `docs/releases/README.md` 版本索引。
- 推送前运行 `npm run verify:release-notes`，确认当前版本已进入正式说明或待整理记录。
- 提交信息或最终汇报中必须说明新版本号。
